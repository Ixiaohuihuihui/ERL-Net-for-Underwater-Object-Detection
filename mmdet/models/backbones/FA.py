...
class FA(nn.Module):
    ...
    def __init__(self,
        ...
        self.fa_1 = conv1_1(320, 256)
        self.fa_2 = conv1_1(3584, 512)
        self.fa_3 = conv1_1(3072, 1024)
    ...
    def forward(self, x):
        ...
        x01 = self.fa_1(x01)
        outs_x4 = x4_sm
        outs_x3 = self.fa_3(x3_sm_cat)
        outs_x2 = self.fa_2(x2_sm_cat)
        outs_x1 = x01
        outs.append(outs_x1)
        outs.append(outs_x2)
        outs.append(outs_x3)
