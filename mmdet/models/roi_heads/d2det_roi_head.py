...
from mmdet.core import bbox2result, bbox2roi, multiclass_nms1, multiclass_nms
...
class D2DetRoIHead(StandardRoIHead):
    ...
    def simple_test(self,
        ...
        if det_bboxes.shape[0] != 0:
            ...
            #     det_bboxes, det_labels = multiclass_nms2(det_bboxes[:, :4], det_bboxes[:, 4], det_labels,
            #                                              self.test_cfg.score_thr, self.test_cfg.nms, 300)
                # det_bboxes, det_labels = multiclass_nms(det_bboxes[:, :4], det_bboxes[:, 4], )
